...
class ListaDeDesejosCadastroPage extends StatefulWidget {
  Transacao? transacaoParaEdicao;
  ListaDeDesejosCadastroPage({Key? key, this.transacaoParaEdicao})
      : super(key: key);

  @override
  State<ListaDeDesejosCadastroPage> createState() =>
      _TransacaoCadastroPageState();
}

class _TransacaoCadastroPageState extends State<ListaDeDesejosCadastroPage> {
